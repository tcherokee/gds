...
<aside
  class="sticky top-0 hidden w-[320px] h-[calc(100vh_-_104px)] shrink-0 py-8 bg-dash-menu-nav-bg px-4 -my-10 lg:block"
>
  <nav class="flex flex-1 flex-col h-full justify-between">
    <ul role="list" class="space-y-0.5">
      <li>
        <a
          href="/dashboard"
          class="text-menu-link-text flex items-center gap-x-3 rounded-tl-md rounded-bl-md py-2.5 px-4 -mr-4 text-base font-medium {activeRoute ===
          'home'
