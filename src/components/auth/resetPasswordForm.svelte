...
<div class="auth-bg flex min-h-full items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
	<div class="auth-form-container p-10 rounded-xl w-full max-w-[440px] space-y-6">
		...
		<form class="space-y-4">
			<div>
				<label for="password"  class="block text-blue-500 text-sm font-medium mb-[6px]">Password</label>
				<input
					id="password"
			...
			<div>
				<label for="password"  class="block text-blue-500 text-sm font-medium mb-[6px]">Confirm Password</label>
				<input
					id="confirm-password"
					class="w-full py-2.5 px-[14px] text-base text-[#000] rounded border border-[rgba(255,255,255,0.30)] focus:border-misc focus:shadow-none"
