<script lang="ts">
	...
	$: console.log($casinoVariables, $wageringReqAmount)

	// linear-gradient(180deg,#163183 0%,#070c3f 100%),
	// linear-gradient(180deg,#3fe6fc 0%,#00bcd4 100%),
	// linear-gradient(180deg,#c2c8ff 0%,#365ccf 100%)
</script>
