                  ...
                  >
                    ...
                    >
                      {#if casino?.attributes?.Badges}
                        ...
                        >
                      {:else if casino?.attributes?.createdAt && dayjs().diff(casino?.attributes?.createdAt, "day") <= 14}
                        <span
                      ...
                      {#if casino?.attributes?.countries && casino?.attributes?.countries.data[0]?.attributes?.countryFlag?.data?.attributes?.url}
