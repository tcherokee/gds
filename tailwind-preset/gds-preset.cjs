...
module.exports = {
  theme: {
    colors: {
      ...
      // Breadcrumb
      "breadcrumb-bkg": COLORS.blue[400],
      ...
      "subNavbar-bkg": COLORS.blue[450],
      "subNavbar-text": COLORS.white,
      "nav-hover-bkg": COLORS.blue[450],
